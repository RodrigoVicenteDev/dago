...
namespace dago.Migrations
{
    ...
    [Migration("20251114151412_TesteLeadTime")]
    partial class TesteLeadTime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dago.Models.ConfiguracaoEsporadico", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ConfiguracoesEsporadico", (string)null);
                });

            modelBuilder.Entity("dago.Models.ConfiguracaoEsporadicoCliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("ConfiguracaoEsporadicoId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ConfiguracaoEsporadicoId");

                    b.ToTable("ConfiguracaoEsporadicoClientes");
                });

            modelBuilder.Entity("dago.Models.ConfiguracaoEsporadicoDestinatario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ConfiguracaoEsporadicoDestinatarios");
                });

            modelBuilder.Entity("dago.Models.ConfiguracaoEsporadicoUnidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ConfiguracaoEsporadicoUnidades");
                });
            ...
            modelBuilder.Entity("dago.Models.OcorrenciaSistema", b =>
                {
                    ...
                    b.Property<int?>("DiasDesdeAnterior")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("dago.Models.ConfiguracaoEsporadicoCliente", b =>
                {
                    ...
                    b.HasOne("dago.Models.ConfiguracaoEsporadico", "ConfiguracaoEsporadico")
                        .WithMany("ClientesExcluidos")
                        .HasForeignKey("ConfiguracaoEsporadicoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Cliente");

                    b.Navigation("ConfiguracaoEsporadico");
                });

            modelBuilder.Entity("dago.Models.ConfiguracaoEsporadicoDestinatario", b =>
                {
                    b.HasOne("dago.Models.ConfiguracaoEsporadico", "ConfiguracaoEsporadico")
                        .WithMany("DestinatariosExcluidos")
                        .HasForeignKey("ConfiguracaoEsporadicoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("dago.Models.ConfiguracaoEsporadico", b =>
                {
                    b.Navigation("ClientesExcluidos");

                    b.Navigation("DestinatariosExcluidos");

                    b.Navigation("UnidadesExcluidas");
                });
